...
sidebarTitle: "Docker"
description: "Use Docker Compose to run both bots and the dashboard alongside MariaDB and Redis in isolated containers, ideal for local development and reproducible environments."
---
