...
description: "Choose your deployment platform: Oracle Cloud free tier, a generic Linux VPS, or Docker Compose. All options support PM2 process management and Nginx reverse proxy."
---
...
3. **Enable PM2 startup on boot** — so both bots restart automatically after a server reboot:
   ```bash
