---
title: "Configure Capinetta RP Bot System Environment"
sidebarTitle: "Configuration"
description: "Complete reference for all environment variables required and optional for running both bots, the web dashboard, Redis caching, and the alert monitoring system."
---
...
<ParamField body="LOGS_CLEANUP_INTERVAL" type="number" default="86400000">
  How often the background job runs to purge audit log entries older than 30 days. Default: `86400000` (1 day).
</ParamField>
