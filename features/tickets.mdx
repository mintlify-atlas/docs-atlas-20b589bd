...
description: "Create support categories, post button panels, manage tickets through claim/transfer/close, generate full HTML transcripts, and track staff KPI metrics."
---
