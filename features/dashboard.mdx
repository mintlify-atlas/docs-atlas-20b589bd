...
description: "Express dashboard with Discord OAuth2 login, Redis-cached KPIs, live metrics, ticket transcripts, warn management, and automated webhook alert delivery."
---
...
<AccordionGroup>
  ...
  <Accordion title="GET /api/guild/:guildId/warns-trend">
  ...
  <Accordion title="GET /api/guilds/comparison">
  ...
  <Accordion title="GET /api/logs/statistics">
