...
description: "Flood detection isolates spammers by saving and stripping their roles, bulk-deletes spam messages, and enforces a verification cooldown to block bot raids."
---
